                        ...
                        {session ? (
                            ...
                            <div class="min-w-0 flex-1">
                                ...
                                <div class="mt-6 flex items-center justify-end space-x-4">
                                    ...
                                    <button type="submit" className="inline-flex items-center justify-center px-3 py-2 text-sm text-white bg-rose-500 hover:bg-rose-600 cursor-pointer" disabled={!content.trim()}>Commenter</button>
                                </div>
                                </form>
                            </div>
                            </div>
