  ...
  return (
    ...
    <div className="container mx-auto p-4">
      ...
      >
        ...
        <textarea 
            id="outputText"
            className="w-full h-60 rounded-md border-gray-300 border px-4 py-2 text-sm placeholder-gray-500 focus:outline-none focus:text-gray-900 focus:placeholder-gray-400 focus:ring-1 focus:ring-rose-500 focus:border-rose-500"
            placeholder="..."
            value={textResult || ""}
            style={{ resize: "none" }}
        ...
        <div class="flex items-center justify-center">
            <div class="relative">
            <div class="inline-block rounded-full w-8 h-8 border-4 border-transparent border-t-white animate-spin"></div>
            </div>
            <span class="ml-2 text-gray-900">Chargement en cours...</span>
        </div> : 
